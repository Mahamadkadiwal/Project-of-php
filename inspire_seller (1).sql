...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2023 at 11:51 AM
...
INSERT INTO `addsinglecategory` (`p_id`, `category`, `subcategory`, `image`, `date`, `seller_price`, `return_price`, `product_name`, `product_weight`, `sizes`, `product_details`, `manufacturer_details`, `product_quantity`, `status`) VALUES
