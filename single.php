            ...
            <div class="col-12 col-sm-6">
              ...
              <div class="btn-group btn-group-toggle" data-toggle="buttons">
                <label class="btn btn-default text-center">
                  ...
                  <span class="text-lg"><?php echo $row['sizes'][0]?></span>
                  <br>
                  Small
                </label>
                <label class="btn btn-default text-center">
                  <input type="radio" name="color_option" id="color_option_b2" autocomplete="off">
                  <span class="text-lg"><?php echo $row['sizes'][2]?></span>
                  <br>
                  Medium
                </label>
                <label class="btn btn-default text-center">
                  <input type="radio" name="color_option" id="color_option_b3" autocomplete="off">
                  <span class="text-lg"><?php echo $row['sizes'][4]?></span>
                  <br>
                  Large
                </label>
                <label class="btn btn-default text-center">
                  <input type="radio" name="color_option" id="color_option_b4" autocomplete="off">
                  <span class="text-lg"><?php echo $row['sizes'][6] . $row['sizes'][7];?></span>
                  <br>
                  Xtra-Large
                </label>
              </div>
              ...
              <div class="bg-gray py-2 px-3 mt-4">
                <h2 class="mb-0">
                  Rs.<?php echo $row['seller_price'];?>
                </h2>
                <h4 class="mt-0">
                  <small>Ex Tax: Rs.<?php echo $row['seller_price'];?> </small>
                </h4>
              </div>
             ...
             <div class="">
              <input type="hidden" name="user_id" id="" value="<?php echo $_SESSION['user_id'];?>" class="form-control">
             </div>
             <?php endif; ?>
              <div class="mt-4">
                <?php if(isset($_SESSION['user_id'])) : 
