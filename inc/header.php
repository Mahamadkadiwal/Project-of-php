...
<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">Inspire Software </a>
    ...
    <li class="nav-item">
        <a class="nav-link me-2" href="category/category.php">Categories</a>
    </li>
    <li class="nav-item">
        <a class="nav-link me-2" href="index.php">Products</a>
    </li>
    <li class="nav-item">
    ...
    <?php if (isset($_SESSION['user_name'])) : ?>
        <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="cart.php"><i class="fas fa-shopping-cart"></i><?php echo $get['num_product'] ?></a>
    </li>
