              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                  <?php $sql = mysqli_query($con, "SELECT 
                                    ...
                                    INNER JOIN users ON orders.user_id = users.id
                                    WHERE 
                                        addsinglecategory.seller_id = '" . $_SESSION['admin_id'] . "' and order_status='4' ");
                  if ($count = mysqli_num_rows($sql)): ?>
                    <div class="inner">
                      <h3>
                        <?php echo $count ?>
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                  <?php $sql = mysqli_query($con, "SELECT 
                                    ...
                                    INNER JOIN users ON orders.user_id = users.id
                                    WHERE 
                                        addsinglecategory.seller_id = '" . $_SESSION['admin_id'] . "' and order_status='2' ");
                  if ($count = mysqli_num_rows($sql)): ?>
                    <div class="inner">
                      <h3>
                        <?php echo $count ?>
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-danger">
                  <?php $sql = mysqli_query($con, "SELECT 
                                    ...
                                    INNER JOIN users ON orders.user_id = users.id
                                    WHERE 
                                        addsinglecategory.seller_id = '" . $_SESSION['admin_id'] . "' and order_status='3' ");
                  if ($count = mysqli_num_rows($sql)): ?>
                    <div class="inner">
                      <h3>
                        <?php echo $count ?>
