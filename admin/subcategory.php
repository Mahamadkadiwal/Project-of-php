...
if (isset($_POST['sub_categories'])) {
    ...
    $sql = mysqli_query($con, "INSERT INTO `sub_categories`(`name`, `description`, `image`, `status`) VALUES ('$name','$desc','$image','1')");
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="category.php" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="category" value="<?= $row['category']; ?>"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="sub_category" class="btn btn-primary">Add Category</button>
                </div>
                </form>
            </div>
        </div>
